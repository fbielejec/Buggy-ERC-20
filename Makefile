...
.PHONY: test-challenge10
test-challenge10:
	forge test --match-path test/Challenge10.t.sol -vv

.PHONY: test-challenge11
test-challenge11:
	forge test --match-path test/Challenge11.t.sol -vv
...
.PHONY: test-challenge14
test-challenge14:
	forge test --match-path test/Challenge14.t.sol -vv

.PHONY: test-challenge15
test-challenge15:
	forge test --match-path test/Challenge15.t.sol -vv

.PHONY: test-challenge16
test-challenge16:
	forge test --match-path test/Challenge16.t.sol -vv
